...
def add_session(root_dir,record_df,owner_id):
    '''
    ...
    **this function was modified 5/16/2017 to include an 'owner' field to deal
    with databases containing data from multiple people
    '''
    ...
    'Left Reward Prob','Reward Given', 'Laser Given']
    ...
    try:  
        ...
        record = {
            ...
            'Date': datetime,
            'Phase': phase,
            'Laser Stim Prob': params['laserstimprob'],
